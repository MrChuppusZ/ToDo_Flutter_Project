      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'sarathkumar',
              style: TextStyle(fontFamily: 'Alfa Slab One',fontSize: 24, fontWeight: FontWeight.bold,color: Color(0xFF6C1D45)),
            ),
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder:(context) => const MyDetails(),));
              },
            ),
            const Spacer(),
            TextButton.icon(
